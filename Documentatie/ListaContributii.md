Vrînceanu Sterică – Interfață grafică și integrarea aplicației
    * PaintApp/Program.cs – a configurat punctul de pornire al aplicației și handler-ele globale pentru   
        excepții.
...
Membrul 2 – Modulul de desen DrawingTools.dll
    ...
    * DrawingTools/ShapeToolBase.cs – a implementat logica de bază reutilizabilă pentru formele geometrice, 
        inclusiv normalizarea coordonatelor.
...
Membrul 4 – Testare și documentație
    ...
    * PaintApp.Tests/StateManagerTests.cs – a scris testele automate pentru DrawCommand și CommandManager.
